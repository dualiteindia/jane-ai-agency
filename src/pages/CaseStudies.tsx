          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <button className="bg-brand-dark text-white text-sm font-medium px-6 py-3 rounded-full hover:bg-black transition-transform hover:scale-105 active:scale-95 duration-300">
                  Book a free call
                </button>
