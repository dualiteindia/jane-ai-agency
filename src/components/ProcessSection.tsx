...
const steps = [
  ...
  },
  {
    ...
    title: "Build & Deploy",
    tag: "Weeks 2-4",
    description: "We create and launch custom systems tailored to your operations without disrupting daily work."
  },
  {
    id: "03",
    title: "Train & Support",
    tag: "Ongoing",
    description: "We train your team and provide ongoing support to keep your automation running smoothly."
  }
];
    ...
    <div className="py-24 border-t border-brand-dark/5">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-5">
          <FadeIn>
            ...
            <h2 className="text-4xl md:text-5xl font-serif text-brand-dark mb-6 leading-tight">
              ...
              <span className="italic text-brand-text/50">without</span> the complexity.
            </h2>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button className="bg-[#EBE9E4] text-brand-dark text-sm font-medium px-6 py-3 rounded-full hover:bg-[#E0DED9] transition-all hover:scale-105 active:scale-95 duration-300 flex items-center gap-2 group">
                Watch the video
        ...
        <div className="lg:col-span-7 flex flex-col gap-12 pt-8">
          {steps.map((step, idx) => (
            <FadeIn key={step.id} delay={idx * 0.1} className="flex gap-6 md:gap-12 group">
              <span className="text-xl font-serif text-brand-text/30 pt-1">{step.id}</span>
