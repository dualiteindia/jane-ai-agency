  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 sm:gap-4 md:gap-8 text-[11px] sm:text-xs md:text-sm font-medium text-brand-dark/80">
        <Link to="/about" className="hover:text-brand-dark transition-colors p-1">About</Link>
        <Link to="/case-studies" className="hover:text-brand-dark transition-colors whitespace-nowrap p-1">Case Studies</Link>
        <Link to="/news" className="hover:text-brand-dark transition-colors p-1">News</Link>
      </div>
      ...
      <div className="md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 shrink-0">
        <Link to="/" className="text-xl sm:text-2xl md:text-4xl font-serif tracking-tight text-brand-dark">
          Jane
        </Link>
      </div>
